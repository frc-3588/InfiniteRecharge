...
acquisitionRButton = new JoystickButton(operatorController, 7);
...
climbingOpenLockButton = new JoystickButton(operatorController, 2);
climbingOpenLockButton.whenPressed(new ClimbOpenLockCommand());
acquisitionOnButton = new JoystickButton(operatorController, 8);
...
acquisitionConveyerRButton = new JoystickButton(driverController, 5);
acquisitionConveyerRButton.whileHeld(new ConveyerReverseCommand());
acquisitionConveyerButton = new JoystickButton(driverController, 6);
