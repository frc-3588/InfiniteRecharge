...
shooterRButton = new JoystickButton(operatorController, 1);
shooterRButton.whileHeld(new ShooterReverseCommand());
acquisitionRButton = new JoystickButton(operatorController, 1);
...
acquisitionConveyerRButton = new JoystickButton(driverController, 1);
